        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LandlordProfiles_Users_AppUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TenantProfiles_Users_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    LandlordProfileId = table.Column<Guid>(type: "uuid", nullable: false),
                    BookingId = table.Column<Guid>(type: "uuid", nullable: false),
                    AmountKobo = table.Column<long>(type: "bigint", nullable: false),
                    PlatformFeeKobo = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payouts_LandlordProfiles_LandlordProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PricePerNightKobo = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Bookings_TenantProfiles_TenantProfileId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "a1b2c3d4-e5f6-7890-abcd-ef1234567890", "f1e2d3c4-b5a6-7890-abcd-ef0987654321", "Admin", "ADMIN" },
                    { "c3d4e5f6-a7b8-9012-cdef-234567890123", "e5f6a7b8-c9d0-1234-efab-456789012345", "Landlord", "LANDLORD" },
                    { "d4e5f6a7-b8c9-0123-defa-345678901234", "f6a7b8c9-d0e1-2345-fabc-567890123456", "Tenant", "TENANT" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "b2c3d4e5-f6a7-8901-bcde-f12345678901", 0, "d4e5f6a7-b8c9-0123-defa-234567890123", new DateTime(2026, 4, 11, 0, 18, 47, 808, DateTimeKind.Utc).AddTicks(5010), "gbolahanagbeleye@gmail.com", true, "Inioluwa", true, true, "Agbeleye", false, null, "GBOLAHANAGBELEYE@GMAIL.COM", "GBOLAHANAGBELEYE@GMAIL.COM", "AQAAAAIAAYagAAAAEAzz0cFB3IkA5ur57n/L7/gnyyQAKmsW0VQmLwPD7+bad+cp9yY/0XJcPK6GOf5Q7w==", null, false, "c3d4e5f6-a7b8-9012-cdef-123456789012", false, null, "gbolahanagbeleye@gmail.com" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_TenantProfileId",
                table: "Bookings",
                column: "TenantProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_LandlordProfiles_AppUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payouts_LandlordProfileId",
                table: "Payouts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TenantProfiles_AppUserId",
                table: "TenantProfiles",
                column: "AppUserId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UnavailableDates_PropertyId",
