...
{
    /// <inheritdoc />
    public partial class RemoveDummySeedData : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { new DateTime(2026, 6, 19, 14, 50, 1, 443, DateTimeKind.Utc).AddTicks(3266), "AQAAAAIAAYagAAAAEBlrVfgV6osEeiLeCFEOyk/tLVDZE8M1Q8Y25bOwwnRCzxxaFT/Y1qRoxg7ZvXWUZw==" });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "e5f6a7b8-c9d0-1234-efab-456789012346", 0, "b2c3d4e5-f6a7-8901-bcde-111111111111", new DateTime(2026, 6, 14, 8, 8, 56, 623, DateTimeKind.Utc).AddTicks(4896), "emeka.obi@gmail.com", true, "Chukwuemeka", true, true, "Obi", false, null, "EMEKA.OBI@GMAIL.COM", "EMEKA.OBI@GMAIL.COM", "AQAAAAIAAYagAAAAEMmpooE4GfU9Kkf90Gv83BdzYdT+8PdkpBXDFeQyXDeLT98ef3lQH+RumRKUuaMdGQ==", null, false, "a1b2c3d4-e5f6-7890-abcd-111111111111", false, null, "emeka.obi@gmail.com" },
                    { "f6a7b8c9-d0e1-2345-fabc-567890123457", 0, "d4e5f6a7-b8c9-0123-defa-222222222222", new DateTime(2026, 6, 14, 8, 8, 56, 726, DateTimeKind.Utc).AddTicks(5042), "amara.nwosu@gmail.com", true, "Amara", true, true, "Nwosu", false, null, "AMARA.NWOSU@GMAIL.COM", "AMARA.NWOSU@GMAIL.COM", "AQAAAAIAAYagAAAAEG5jdTjtuuWfcpd6A90A7q4OZNCHRoyJZaUQT2ocIYD3tx5arYnqPugYNOM38ynv9A==", null, false, "c3d4e5f6-a7b8-9012-cdef-222222222222", false, null, "amara.nwosu@gmail.com" }
                });

            migrationBuilder.InsertData(
                table: "LandlordProfiles",
                columns: new[] { "Id", "AppUserId", "CancellationCount", "CreatedAt", "IsVerified", "UpdatedAt" },
                values: new object[,]
                {
                    { new Guid("a1b2c3d4-5678-90ab-cdef-111111111111"), "e5f6a7b8-c9d0-1234-efab-456789012346", 0, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), true, null },
                    { new Guid("b2c3d4e5-6789-01bc-def0-222222222222"), "f6a7b8c9-d0e1-2345-fabc-567890123457", 0, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), true, null }
                });
